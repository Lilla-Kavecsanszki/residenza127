...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'residenza.context_processors.available_languages', # custom context processor for the language switcher
            ],
            'builtins': [
...
if 'DEVELOPMENT' in os.environ:
    ...
    EMAIL_USE_TLS = True
    EMAIL_PORT = 587
    EMAIL_HOST = 'smtp.sendgrid.net'  # Replace with your SMTP host
